@extends("structure",['title'=>"Projects"])
@section("content")
<div class="overflow-x-auto">
        <div class="flex items-center justify-center min-h-screen overflow-hidden font-sans min-w-screen">
            <table class="w-full rounded shadow-md table-auto lg:w-5/6 min-w-max" id="table_id">
                <thead>
